<?php
    ...
    // Jointure des deux tables (user et minichat) et récupérer les 10 derniers message, il est important de faire étape par étape 
            ...
            <div class='card mb-0 message'>
                <div class='card-body'>
                    <p class='my-0'>
                        ...
                        <span class='badge badge-secondary float-right createdat'>" . $message['date'] . "</span>
                    </p>
                </div>
            </div>
        </div>";
